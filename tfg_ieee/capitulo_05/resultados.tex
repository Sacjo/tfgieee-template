...
A continuación, se presentan las principales vistas y módulos funcionales que conforman la versión final del sistema.
...
\caption{Interfaz de inicio de sesión del sistema Fuente: [Elaboración Propia].}
\label{fig:login}
\end{figure}
...
\textbf{Registro de usuario:}  
  ...
  \begin{figure}[H]
    ...
    \caption{Formulario de registro de usuario Fuente: [Elaboración Propia].}
    \label{fig:new_user}
  \end{figure}
...
Los datos presentados son demostrativos y se incluyen únicamente con fines ilustrativos.
  ...
  \begin{figure}[H]
    ...
    \caption{Gráfico de asistencias por día en el módulo Dashboard Fuente: [Elaboración Propia].}
...
Al igual que en la vista anterior, los datos visualizados son de carácter demostrativo y no representan información real.
  ...
  \begin{figure}[H]
    ...
    \caption{Listado de estudiantes y asistencias registradas en el módulo Dashboard Fuente: [Elaboración Propia].}
...
Todo el flujo de reconocimiento se ejecuta localmente y en tiempo real, ofreciendo una experiencia precisa y eficiente.
  ...
  \begin{figure}[H]
    ...
    \caption{Módulo de reconocimiento facial automático Fuente: [Elaboración Propia].}
...
Incluye un formulario para ingresar la descripción del rol y una tabla con opciones de edición y eliminación, asegurando la integridad de los datos mediante confirmaciones previas a cada operación.
  ...
  \begin{figure}[H]
    ...
    \caption{Gestión de roles: registro, edición y eliminación Fuente: [Elaboración Propia].}
    \label{fig:roles}
  \end{figure}
...
Incluye además un listado con acciones de edición y eliminación, facilitando la administración académica de las clases.
  \begin{figure}[H]
    ...
    \caption{Registro y gestión de cursos Fuente: [Elaboración Propia].}
    \label{fig:new_curso}
  \end{figure}
...
La sección inferior presenta una tabla de horarios filtrable por curso, día o aula.
  ...
  \begin{figure}[H]
    ...
    \caption{Registro y gestión de horarios por cursoFuente: [Elaboración Propia].}
...
El formulario incluye los campos estudiante, curso, fecha y observaciones, garantizando la completitud y precisión de los registros.
  ...
  \begin{figure}[H]
    ...
    \caption{Módulo de registro manual de asistencias Fuente: [Elaboración Propia].}
...
De esta manera, se facilita la organización de los grupos de clase y la administración de las asistencias.
  ...
  \begin{figure}[H]
    ...
    \caption{Asignación de cursos a participantes Fuente: [Elaboración Propia].}
    \label{fig:asignar}
  \end{figure}
...
\begin{table}[H]
    \centering
    \caption{Componentes de hardware y software utilizados en el sistema Fuente: [Elaboración Propia].}
...
\begin{table}
    \centering
    \caption{Errores frecuentes y acciones de mitigación Fuente: [Elaboración Propia].}
...
\begin{table}[H]
\centering
\caption{Configuración de umbral centrada en 0.45 y resultado esperado (distancia entre embeddings expresada como valor porcentual). Fuente: [Elaboración Propia].}
...
\begin{figure}[H]
    ...
    \caption{Fragmento de código utilizado para configurar el umbral de reconocimiento Fuente: [Elaboración Propia].}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Muy estricto, reconoce solo rostros casi idénticos Fuente: [Elaboración Propia].}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Estricto, buena precisión, pero sensible a luz o expresión Fuente: [Elaboración Propia].}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Equilibrado, balance entre precisión y tolerancia Fuente: [Elaboración Propia].}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Moderadamente flexible, admite pequeñas variaciones Fuente: [Elaboración Propia].}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Puede aceptar coincidencias con diferencias notables Fuente: [Elaboración Propia].}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Prueba inicial del sistema bajo condiciones de iluminación máxima, con detección de personas registradas y no registradas Fuente: [Elaboración Propia].}
    \label{fig:prueba1}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Prueba a mayor distancia, con leve disminución en la similitud pero reconocimiento correcto de los usuarios registrados Fuente: [Elaboración Propia].}
    \label{fig:prueba4}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Prueba con iluminación reducida, mostrando una disminución natural en la precisión de reconocimiento Fuente: [Elaboración Propia].}
    \label{fig:prueba5}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Prueba con iluminación mínima, donde el sistema no logró reconocer a los participantes Fuente: [Elaboración Propia].}
    \label{fig:prueba6}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Prueba con condiciones normales de iluminación y cambio de posición de los participantes registrados Fuente: [Elaboración Propia].}
    \label{fig:prueba7}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Prueba con la cámara a una altura de aproximadamente 2.3 metros, mostrando un reconocimiento estable Fuente: [Elaboración Propia].}
    \label{fig:prueba8}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Prueba con ocho participantes en el encuadre, reconociendo correctamente a los seis usuarios registrados Fuente: [Elaboración Propia].}
    \label{fig:prueba9}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Prueba grupal con iluminación mínima, sin reconocimiento exitoso de los usuarios registrados Fuente: [Elaboración Propia].}
    \label{fig:prueba10}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Prueba con la cámara a 2.2 metros de altura y posiciones diversas de los participantes, evidenciando un desempeño estable Fuente: [Elaboración Propia].}
    \label{fig:prueba11}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Prueba final con variación del ángulo de la cámara, mostrando estabilidad en los niveles de similitud Fuente: [Elaboración Propia].}
    \label{fig:prueba12}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Usuarios registrados dentro del sistema de reconocimiento facial Fuente: [Elaboración Propia].}
...
\begin{figure}[H]
    ...
    \caption{Procesamiento de imágenes y generación de vectores de características (embeddings) para cada usuario registrado Fuente: [Elaboración Propia].}
...
\begin{figure}[H]
    ...
    \caption{Registros de asistencias generados automáticamente por el sistema en la base de datos Fuente: [Elaboración Propia].}
...
\begin{table}[H]
\centering
\caption{Resumen de métricas obtenidas durante las pruebas finales en aula Fuente: [Elaboración Propia].}
