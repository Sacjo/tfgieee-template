...
Área de estudio: Automatización y Control.\\[1em]
...
\\ \hspace{2cm} 3. Aprendizaje profundo, 4. Asistencia automatizada,
\\ \hspace{2cm} 5. Visión por computadora, 6. Gestión académica.\\

Facial recognition-based assistance system for FPUNE. \\
Key words:  1. Facial recognition, 2. Biometrics, 
\\ \hspace{2cm} 3. Deep learning, 4. Automated attendance, 
\\ \hspace{2cm} 5. Computer vision, 6. Academic management. \\
\\
\hline
\end{tabular}
\end{center}
