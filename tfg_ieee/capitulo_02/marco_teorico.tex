...
Es una subárea del aprendizaje automático que se fundamenta en el uso de \textbf{redes neuronales artificiales} con múltiples capas interconectadas. Estas redes permiten transformar progresivamente los datos de entrada en representaciones de mayor nivel de abstracción, adecuadas para tareas complejas como la clasificación de imágenes o el reconocimiento de patrones\cite{perez2021}.
