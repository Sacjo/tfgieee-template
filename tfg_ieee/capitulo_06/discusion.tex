...
En síntesis, la implementación del sistema demostró ser una solución técnica factible y beneficiosa, capaz de reducir errores humanos y optimizar los procesos administrativos relacionados con el control de asistencia.
...
\textbf{5. Realizar pruebas de implementación}
...
El objetivo general de implementar un sistema de reconocimiento facial para el control de asistencia de estudiantes de la Facultad Politécnica de la Universidad Nacional del Este fue alcanzado satisfactoriamente. Se desarrolló una solución funcional que automatiza el registro de asistencia de manera precisa, rápida y sin intervención manual.
