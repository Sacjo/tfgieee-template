...
% fancyhdr: altura de encabezado suficiente
\usepackage{fancyhdr}
\setlength{\headheight}{14.5pt} % o un valor similar sugerido por el log
...
\include{./capitulo_03/Herramientas_Tecnologicas}
