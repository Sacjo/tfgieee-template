...
% \usepackage{array}
% \setlength{\arrayrulewidth}{0.6pt} % (opcional) grosor de líneas
...
\begin{scriptsize}
\begin{tabular}{|>{\columncolor[rgb]{0.85,0.85,0.85}}p{6.9cm}|*{10}{c|}}
\hline
& \multicolumn{10}{>{\columncolor[rgb]{0.85,0.85,0.85}}c|}{2025} \\
\multirow{-2}{*}{\centering Tarea}
& \cellcolor[rgb]{0.85,0.85,0.85}Mar
& \cellcolor[rgb]{0.85,0.85,0.85}Abr
& \cellcolor[rgb]{0.85,0.85,0.85}May
& \cellcolor[rgb]{0.85,0.85,0.85}Jun
& \cellcolor[rgb]{0.85,0.85,0.85}Jul
& \cellcolor[rgb]{0.85,0.85,0.85}Ago
& \cellcolor[rgb]{0.85,0.85,0.85}Sep
& \cellcolor[rgb]{0.85,0.85,0.85}Oct
& \cellcolor[rgb]{0.85,0.85,0.85}Nov
& \cellcolor[rgb]{0.85,0.85,0.85}Dic \\
\hline

Recopilación de información
& \cellcolor{green!45}\textbf{100\%} & & & & & & & & & \\
...
Análisis y selección de algoritmo de reconocimiento facial
& \cellcolor{green!45}\textbf{100\%} & & & & & & & & & \\
...
& & \cellcolor{red!65} & \cellcolor{red!65} & \cellcolor{red!65} &
\cellcolor{red!65} & \cellcolor{red!65}{\textbf{\textcolor{white}{80\%}}} & & & & \\

Integración de la base de datos con el sistema
& & & & \cellcolor{green!45}\textbf{100\%} & \cellcolor{green!45} & & & & & \\

Evaluación del cumplimiento de los requisitos
& & & & & & \cellcolor{red!65} & \cellcolor{red!65}{\textbf{\textcolor{white}{85\%}}} & & & \\


Documentación de los resultados de las pruebas
& & & & & & & & \cellcolor{gray!35} & \cellcolor{gray!35} & \\
