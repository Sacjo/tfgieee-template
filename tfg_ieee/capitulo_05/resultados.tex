...
Además, se incorporó un panel administrativo (\textit{dashboard}) que permite visualizar en tiempo real los resultados de las asistencias registradas y acceder al historial completo de los datos almacenados en la base de datos. 
