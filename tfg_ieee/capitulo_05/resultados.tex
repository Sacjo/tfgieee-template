...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{capitulo_05/imagenes/1.jpg}
    \caption{Fragmento de código utilizado para configurar el umbral de reconocimiento facial.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{capitulo_05/imagenes/umbral_1.0_30.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{capitulo_05/imagenes/2.png}
    \caption{Fragmento de código utilizado para configurar el umbral de reconocimiento facial.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{capitulo_05/imagenes/1.3_min_dist25.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{capitulo_05/imagenes/3.png}
    \caption{Fragmento de código utilizado para configurar el umbral de reconocimiento facial.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{capitulo_05/imagenes/umbral1.8min_dist20.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{capitulo_05/imagenes/6.png}
    \caption{Fragmento de código utilizado para configurar el umbral de reconocimiento facial.}
\end{figure}
